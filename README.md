...
* generated with [Generator Mobile](https://github.com/yeoman/generator-mobile)
* extended with [Angular](https://angularjs.org/) to include partials for a single-page app
